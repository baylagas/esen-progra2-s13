...
function modifyOnElementByIndex(pIndex) {
    ...
    children[1].innerHTML = "<input type='number' id='inpNum1x" + pIndex + "' value='" + children[1].innerText + "'>"
    children[2].innerHTML = "<input type='number' id='inpNum2x" + pIndex + "' value='" + children[2].innerText + "'>"
